...
ConVar sv_proximitychat("sv_proximitychat", "0", FCVAR_NOTIFY | FCVAR_REPLICATED, "");
//ConVar sv_proximitydistance("sv_proximitydistance", "0", FCVAR_NOTIFY | FCVAR_REPLICATED, "");
